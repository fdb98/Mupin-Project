    ...
    <form action="backend/fs_aimed.php"  method="post">
        <fieldset>
        <h2 class="field_ricerca green">Ricerca Veloce e Precisa</h2>    
        <div class="input-group mb-3 shadow">
            <button type="button" class='btn btn-primary'><label for='fst_categoria1'>Categoria</label></button>
            ...
            <button type="button" class='btn btn-info'><label for='fst_idcatalogo'>ID Catalogo</label></button>
